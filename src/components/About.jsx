...
const About = () => {
  return (
    <div name="about" className="mt-32">
      ...
      <div className="pt-20">
        ...
        <div className="lg:flex justify-evenly grid grid-cols-2 pl-20 lg:pl-0   gap-3 pt-2">
          ...
          <div>
            {" "}
            <IoLogoCss3 className="text-sky-400" size={50} />
            <span className="pl-1 font-semibold">CSS3</span>
          </div>
          <div className="">
            {" "}
            <BiLogoTailwindCss className="text-sky-400 " size={50} />
          ...
          <div>
            {" "}
            <IoLogoJavascript className="text-sky-400" size={50} />
            <span className="font-semibold">ES6</span>
          </div>
          <div>
            {" "}
            <FaReact className="text-sky-400 " size={50} />
            <span className=" font-semibold">ReactJS</span>
          </div>
          <div>
            {" "}
            <IoLogoFirebase className="text-sky-400 " size={50} />
            <span className=" font-semibold">Firebase</span>
          </div>
          <div>
            {" "}
            <FaNodeJs className="text-sky-400" size={50} />
            <span className=" font-semibold">Express</span>
          </div>
          <div>
            {" "}
            <SiMongodb className="text-sky-400" size={50} />

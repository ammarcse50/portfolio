 ...
 <div className="card card-compact xl:w-96 xl:p-3 bg-base-100 shadow-xl hover:shadow-lg hover:shadow-[#00eeff] ">
  ...
  <div className="card-body">
    ...
    <div className=" flex justify-between">
      <a href="https://mahad-al-hind.web.app/"><button className="btn btn-primary hover:bg-[#00eeff]">Demo</button></a>
      <a href={link1}><button className="btn btn-primary hover:bg-[#00eeff]">Code</button></a>
    </div>
    <div className="">
